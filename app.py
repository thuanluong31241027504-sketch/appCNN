...
with st.sidebar:
    ...
    st.text("Khay 1: [0:715, 64:687]")
    st.text("Khay 2: [52:723, 808:1307]")
    st.text("Khay 3: [760:1206, 30:461]")
    st.text("Khay 4: [760:1229, 472:897]")
    st.text("Khay 5: [749:1247, 892:1315]")
...
with col2:
    ...
    if 'processed' in st.session_state and st.session_state['processed']:
        ...
        # CẮT ẢNH THEO TỌA ĐỘ ĐÃ ĐIỀU CHỈNH
...
# Footer
st.markdown("---")
st.caption("Food Detection System v1.0 - Toa do da dieu chinh")
